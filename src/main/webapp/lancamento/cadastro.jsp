...
<div class="card">
    ...
    <div class="card-body">
        <form action="${pageContext.request.contextPath}/lancamento/cadastro" method="post" class="row g-3 needs-validation" novalidate>
            <div class="col-md-12">
                <label for="dsLancamento">Descrição do Lançamento</label>
                <input type="text" class="form-control ${ msgs.containsKey('dsLancamento') ? 'is-invalid' : '' }" id="dsLancamento" name="dsLancamento" placeholder="Digite a descrição do lançamento" minlength="3" maxlength="50" required="required">
            ...
            <div class="col-md-12">
                ...
                <input type="text" class="form-control money2 ${ msgs.containsKey('vlLancamento') ? 'is-invalid' : '' }" id="vlLancamento" name="vlLancamento" placeholder="Digite a descrição do lançamento" minlength="1" maxlength="50" required="required">
                <c:if test="${msgs != null && not empty msgs.dsLancamento}">
                    <div class="invalid-feedback">
                        ${ msgs.dsLancamento }
                    </div>
            ...
            <div class="col-md-12">
                ...
                <select class="form-select ${ msgs.containsKey('cdConta') ? 'is-invalid' : '' }" aria-label="Select Conta" id="cdConta" name="cdConta" required>
	                ...
	                <c:forEach items="${ contas }" var="conta">
	                	<option value="${ conta.id }">Ag: ${ conta.vlAgencia } - Conta: ${ conta.vlConta }</option>
	                </c:forEach>
                </select>
            ...
            <div class="col-md-12">
                ...
                <select class="form-select ${ msgs.containsKey('cdTipoLancamento') ? 'is-invalid' : '' }" aria-label="Select Tipo Lancamento" id="cdTipoLancamento" name="cdTipoLancamento" required>
	                ...
	                <c:forEach items="${ tiposLancamento }" var="tipoLancamento">
	                	<option value="${ tipoLancamento.id }">${ tipoLancamento.dsTipo }</option>
	                </c:forEach>
                </select>
            ...
            <div class="col-md-12" id="divTipoInvestimento">
                ...
                <select class="form-select ${ msgs.containsKey('cdTipoInvestimento') ? 'is-invalid' : '' }" aria-label="Select Tipo Investimento" id="cdTipoInvestimento" name="cdTipoInvestimento" required>
	                ...
	                <c:forEach items="${ tiposInvestimento }" var="tipoInvestimento">
	                	<option value="${ tipoInvestimento.id }">${ tipoInvestimento.dsTipoInvestimento }</option>
	                </c:forEach>
                </select>
